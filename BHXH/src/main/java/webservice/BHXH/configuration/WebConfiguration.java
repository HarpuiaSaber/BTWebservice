...
public class WebConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public PersistentTokenRepository persistentTokenRepository() {
        ...
        try {
            /// insert to db;
            String sql = "INSERT INTO user(id, dob, enabled, gender, identity, name, password, phone, role, username, support_type, village_id) VALUES(1, '1998-04-25 00:00:00', 1, 1, 123456789, 'XuXu', '$2a$12$utPye5L4xWAUx1IhfY2rAudifM56z5UoAMnZBA1htS5vyl.Lv5BQ.','0123456789', 0, 'admin', 3, 12640);";
